    ...
    try:
        ...
        for window in windows1:
            ...
            if middle_bigram and middle_bigram in political_bigrams:
                ...
                conditional_deceppos = len([word for word in window_words1 if word in allwords1['positive']])
                conditional_decepneg = len([word for word in window_words1 if word in allwords1['negative']])
                
                conditional_deceppos *= tfidf1
                conditional_decepneg *= tfidf1
                if answer[0] == 'yes':
        ...
        for window in windows2:
            ...
            if middle_bigram and middle_bigram in political_bigrams:
                ...
                if middle_bigram1 not in political_bigrams and middle_bigram2 not in political_bigrams:
                    ...
                    conditional_deceppos = len([word for word in window_words2 if word in allwords1['positive']])
                    conditional_decepneg = len([word for word in window_words2 if word in allwords1['negative']])
                    
                    conditional_deceppos *= tfidf2
                    conditional_decepneg *= tfidf2
                    if answer[0] == 'yes':
        ...
        for window in windows3:
            ...
            if middle_bigram and middle_bigram in political_bigrams:
                ...
                if middle_bigram3 not in political_bigrams and middle_bigram4 not in political_bigrams:
                    ...
                    conditional_deceppos = len([word for word in window_words3 if word in allwords1['positive']])
                    conditional_decepneg = len([word for word in window_words3 if word in allwords1['negative']])
                    
                    conditional_deceppos *= tfidf3
                    conditional_decepneg *= tfidf3
                    if answer[0] == 'yes':
        ...
        for window in windows1_narr:
            ...
            if middle_bigram and middle_bigram in political_bigrams:
                ...
                conditional_deceppos_narr = len([word for word in window_words1_narr if word in allwords1['positive']])
                conditional_decepneg_narr = len([word for word in window_words1_narr if word in allwords1['negative']])
                
                conditional_deceppos_narr *= tfidf1
                conditional_decepneg_narr *= tfidf1
                if answer[0] == 'yes':
        ...
        for window in windows2_narr:
            ...
            if middle_bigram and middle_bigram in political_bigrams:
                ...
                if middle_bigram1 not in political_bigrams and middle_bigram2 not in political_bigrams:
                    ...
                    conditional_deceppos_narr = len([word for word in window_words2_narr if word in allwords1['positive']])
                    conditional_decepneg_narr = len([word for word in window_words2_narr if word in allwords1['negative']])
                    
                    conditional_deceppos_narr *= tfidf2
                    conditional_decepneg_narr *= tfidf2
                    if answer[0] == 'yes':
        ...
        for window in windows3_narr:
            ...
            if middle_bigram and middle_bigram in political_bigrams:
                ...
                if middle_bigram3 not in political_bigrams and middle_bigram4 not in political_bigrams:
                    ...
                    conditional_deceppos_narr = len([word for word in window_words3_narr if word in allwords1['positive']])
                    conditional_decepneg_narr = len([word for word in window_words3_narr if word in allwords1['negative']])
                    
                    conditional_deceppos_narr *= tfidf3
                    conditional_decepneg_narr *= tfidf3
                    if answer[0] == 'yes':
        ...
        for window in windows1_qa:
            ...
            if middle_bigram and middle_bigram in political_bigrams:
                ...
                conditional_deceppos_qa = len([word for word in window_words1_qa if word in allwords1['positive']])
                conditional_decepneg_qa = len([word for word in window_words1_qa if word in allwords1['negative']])
                
                conditional_deceppos_qa *= tfidf1
                conditional_decepneg_qa *= tfidf1
                if answer[0] == 'yes':
        ...
        for window in windows2_qa:
            ...
            if middle_bigram and middle_bigram in political_bigrams:
                ...
                if middle_bigram1 not in political_bigrams and middle_bigram2 not in political_bigrams:
                    ...
                    conditional_deceppos_qa = len([word for word in window_words2_qa if word in allwords1['positive']])
                    conditional_decepneg_qa = len([word for word in window_words2_qa if word in allwords1['negative']])
                    
                    conditional_deceppos_qa *= tfidf2
                    conditional_decepneg_qa *= tfidf2
                    if answer[0] == 'yes':
        ...
        for window in windows3_qa:
            ...
            if middle_bigram and middle_bigram in political_bigrams:
                ...
                if middle_bigram3 not in political_bigrams and middle_bigram4 not in political_bigrams:
                    ...
                    conditional_deceppos_qa = len([word for word in window_words3_qa if word in allwords1['positive']])
                    conditional_decepneg_qa = len([word for word in window_words3_qa if word in allwords1['negative']])
                    
                    conditional_deceppos_qa *= tfidf3
                    conditional_decepneg_qa *= tfidf3
                    if answer[0] == 'yes':
...
split_and_store_transcripts(transcripts_raw, 'seperate_files_small_bywords_test')
seperate_files = glob.glob('seperate_files_small_bywords_test/*_seperate.json')
processed_folder = 'processed_files_small_bywords_test'
os.makedirs(processed_folder, exist_ok=True)

scores = {}
for seperate_file in seperate_files:
    file_scores,answers = process_scores_file(seperate_file, processed_folder, political_bigrams, allwords1)
